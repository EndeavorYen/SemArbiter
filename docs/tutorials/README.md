...
| **[教程 06](06_transformer_lm_head_optimization.md)** | Transformer Sliced LM Head 投影優化 | *(規劃中)* 詞表矩陣切片、RTX 5080 記憶體頻寬解耦、跳過 150k 全詞表解碼 | [#7](https://github.com/EndeavorYen/SemIf/issues/7) |
