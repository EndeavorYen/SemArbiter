...
| **[教程 13](13_semif_vision_routes_and_tradeoffs.md)** | SemIf-Vision 多模態路線分析與架構抉擇 | 幀時序動態事件（加塞 2/2 全過）、雙 Jev 階層式包容、純相機 IPM 碰撞檢測、端到端語意轉譯鏈路 | [#48](https://github.com/EndeavorYen/SemIf/issues/48) [#90](https://github.com/EndeavorYen/SemIf/issues/90) [#101](https://github.com/EndeavorYen/SemIf/issues/101) |
